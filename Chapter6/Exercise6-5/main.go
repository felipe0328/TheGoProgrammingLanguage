// Exercise 6.5 The type of each word used by IntSet is uint64, but 64-bit arithmetic
// may be inefficient on a 32-bit platform. Modify the program to use the uint type,
